...
import it.feira.business.boundary.ArticoloFacade;
...
public class ArticoloController implements Serializable {
    ...
    @EJB private it.feira.business.boundary.ArticoloFacade ejbFacade;
    ...
    public Articolo getArticolo(java.lang.Long id) {
